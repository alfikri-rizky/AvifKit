...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Shared",
            url: "https://github.com/alfikri-rizky/AvifKit/releases/download/v0.2.8/Shared.xcframework.zip",
            checksum: "45a166c01bbca9b63b51011ddf74bef04f6068ba54cf50db95b2a4dd1ca347c6"
        ),
