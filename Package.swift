...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "Shared",
            url: "https://github.com/alfikri-rizky/AvifKit/releases/download/v0.2.6/Shared.xcframework.zip",
            checksum: "5751f1eb95c9638595c6a12bd42afd55f9a5a46d29ba6a181e5b40259da36960"
        ),
